...
class Listeo {
  ...
  function Activated(){
            ...
            $settings['general'] = array(
             'title'                 => __( '<i class="fas fa-sliders-h"></i> General', 'listeo_core' )
          );

          $settings['maps'] = array(
            'title'                 => __( '<i class="fas fa-map-marked-alt"></i> Map Settings', 'listeo_core' ),
          );

          $settings['submit_listing'] = array(
            'title'                 => __( '<i class="fas fa-plus-square"></i> Submit Listing', 'listeo_core' ),
          );
          
          $settings['listing_packages'] = array(
            'title'                 => __( '<i class="fas fa-cubes"></i> Packages Options', 'listeo_core' ),
          );
          
          $settings['single'] = array(
            'title'                 => __( '<i class="fas fa-file"></i> Single Listing', 'listeo_core' ),
          );
          
          $settings['booking'] = array(
            'title'                 => __( '<i class="fas fa-calendar-alt"></i> Booking', 'listeo_core' ),
          );
          $settings['browse'] = array(
            'title'                 => __( '<i class="fas fa-search-location"></i> Browse Listing', 'listeo_core' ),
          );

          $settings['registration'] = array(
              'title'                 => __( '<i class="fas fa-user-friends"></i> Registration', 'listeo_core' ),
          );
          
          $settings['pages'] = array(
            'title'                 => __( '<i class="fas fa-layer-group"></i> Pages', 'listeo_core' ),
          );

          $settings['emails'] = array(
            'title'                 => __( '<i class="fas fa-envelope"></i> Emails', 'listeo_core' ),
          );
