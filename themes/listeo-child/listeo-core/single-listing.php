...
<div class="container notification_div" <?php if(isset($_GET["hide"]) && $_GET["hide"] == true){ ?> style="display:none" <?php } ?>>
    ...
    $licence_is_active = get_post_meta($post->ID,'licence_is_active',true);
        ...
        <div class="row">
            ...
            <div class="col-md-12 listing_title">
                <div class="alert alert-info" role="alert">
                    ...
                    ?>
                   <?php echo __("Utleieobjekt","gibbs");?> <?php echo $titlee1;?><?php echo __(" er ikke tilgjengelig offentlig siden den er et utkast","gibbs");?> 
                </div>
            </div>
            ...
            <div class="col-md-12 listing_title">
                <div class="alert alert-info" role="alert">
                    <?php
                     $titlee1 = (strlen(get_the_title()) > 200) ? substr(get_the_title(),0,200).'...' : get_the_title();
                    ?>
                    <?php echo __("Utleieobjektet","gibbs");?> <?php echo $titlee1;?><?php echo __(" er ikke tilgjengelig offentlig siden den er inaktiv","gibbs");?> 
                </div>
            </div>
    ...
    <?php }else if($licence_is_active == "false"){ ?>
            ...
            <div class="col-md-12 listing_title">
                <div class="alert alert-warning" role="alert">
                    <?php
                     $titlee1 = (strlen(get_the_title()) > 200) ? substr(get_the_title(),0,200).'...' : get_the_title();
                    ?>
                    <?php echo __("Licence not active","gibbs");?> 
                </div>
            </div>
