...
<style type="text/css">
    ...
    .first_div_class input[type="radio"]:before,
    .first_div_class input[type="radio"]:after{
        display: none;
    }
...
//update_user_meta($current_user->ID, 'profile_type', "company");
    ...
    <div class="col-lg-8 col-md-8 padding-right-30">
            ...
            <div class="row">
                ...
                <div class="first_div_class">
                    ...
                    $checked_type = "personal";

                    if(get_user_meta($current_user->ID, 'profile_type', true) == "company"){
                        $checked_type = "company";
                    }else if(get_user_meta($current_user->ID, 'profile_type', true) == "personal"){
                        $checked_type = "personal";
                    }else if($default_customer_type == "organisation"){
                        $checked_type = "company";
                    }else if($default_customer_type == "private"){
                        $checked_type = "personal";
                    }
                    ...
                    <div class="col-md-12" style="display:flex;">
                        <input style="margin-right:10px;" type="radio" id="radio_personal" name="personalorcompany" value="personal" <?php if($checked_type == "personal"){?> checked="checked" <?php } ?>>
                        <p style="line-height:15px;">Privat</p>
                        <input style="margin-right:10px;margin-left:20px;" type="radio" name="personalorcompany" value="company" <?php if($checked_type == "company"){?> checked="checked" <?php } ?>>
            ...
            <div class="third_div_booking" <?php if($hide_booking_message == "hide"){echo "style='display:none'";}?>>
                <!-- /// -->
                ...
                <div class="pdfDoc" style="background:#f9f9f9;font-family:source sans pro;padding:15px;">
                    ...
                    <div id="pdfLinks">
                            <?php for ($i = 0; $i < 10; $i++) {
                                ...
                                $linkName = end($path);
                                if ($link != null) { ?>
                                    <div class="pdfLinksInner">
                                        <input style="margin: 0 0 0 15px;width: 30px;height:30px;" type="checkbox" id="pdfApprove">
...
var phoneLengthMapping = {
    ...
    $(document).ready(function() {
        $("input[name='personalorcompany']").change(function() {
            var test = $(this).val();
            ...
            if (test == "Personal" || test == "personal") {
                ...
                $("#lastname").show();
                $('#label_firstname').html(label_firstname + "* <span style='display:none;color:red;'> *</span>");
                $('#label_phone').html(label_phone + "* <span style='display:none;color:red;'> *</span>");
            } else {
                ...
                $('#label_firstname').html(label_Navn + "* <span style='display:none;color:red;'> *</span>");
                $('#label_phone').html(label_phone + "* <span style='display:none;color:red;'> *</span>");
        ...
        $("input[name='personalorcompany']:checked").change();
    });
</script>