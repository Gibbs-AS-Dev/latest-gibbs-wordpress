		...
		<div class="categories-boxes-container<?php if($settings['style']=='alt'){ echo "-alt"; }?> margin-top-5 margin-bottom-30">
			...
			<?php 
      		foreach ( $terms as $term ) { 
		        ...
		        ?>
			<a href="<?php echo get_term_link( $term ); ?>" class="category-small-box<?php if($settings['style']=='alt'){ echo "-alt"; }?>">
				...
				<?php if($settings['show_counter']=="yes") { ?><span  class="category-box-counter<?php if($settings['style']=='alt'){ echo "-alt"; }?>"><?php   $count = listeo_get_term_post_count($settings['taxonomy'],$term->term_id); echo $count ?></span> <?php } ?>
