<div id="template-popup" class="template-popup">
    ...
    <div class="mbsc-form-group">
    	...
    	<div class="header_div">
    		...
    		<div class="top_temp">
                <!-- <div class="temp1 create_template_cal"><i class="fa fa-circle-plus"></i>Create template</div> -->
    			<div class="temp2"><h4>Velg visning</h4></div> 
    			<div class="temp3 close_template close_tmp"><i class="fa fa-close "></i></div>
    		</div>
     ...
     <div class="last_tmp_div">
       ...
       <!--  <div class="row row-bottom">
            <label for="update_template_auto" class="update_template_auto_main">
                <input  mbsc-switch data-label="Oppdater visning automatisk" type="checkbox" id="update_template_auto" name="update_template_auto" <?php if($update_template_auto == "yes") { echo "checked"; }?>>
            </label>
        </div>
 -->
