                ...
                if(!empty($_slots)){
                    ...
                    if(!empty($_slots_for_days)){
                        ...
                        foreach ($_slots_for_days as $key => $_slot) {
                            ...
                            $date_start2 = $slot_calculate_date["date_start"];
                            $date_end2 = $slot_calculate_date["date_end"];

                            $result = self ::  get_slots_bookings( $date_start2, $date_end2, array( 'listing_id' => $listing_id, 'type' => 'reservation' ),'booking_date','','','slot_booking'  );
    ...
    public function check_gifts_code($coupon,$listing_id){
        ...
        if(class_exists("Class_Gibbs_Giftcard")){
            ...
            if($data && isset($data["id"])){
                ...
                $voucher_type = get_post_meta($data["id"], 'voucher_type', true);
                $voucher = false;
