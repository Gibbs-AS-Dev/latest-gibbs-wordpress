...
//     }
    ...
    */
    public  function mark_as_read( $conversation)  {
        ...
        if($conv[0]->user_1 == get_current_user_id() || $conv[0]->user_1 == $group_admin) {
            $user = 'user_1';
        } else {
            $user = 'user_2';
        }
	...
	*/
	public  function check_if_read( $conversation_data)  {
        ...
        if(isset($conversation_data)){
            ...
            }else if( (string) $conversation_data[0]->user_1 == $group_admin){
                return $conversation_data[0]->read_user_1;
            } else if( (string) $conversation_data[0]->user_2 == $group_admin){
