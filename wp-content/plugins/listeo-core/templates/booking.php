			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="input-with-icon medium-icons">
						<label><?php esc_html_e('E-Mail Address', 'listeo_core'); ?><?php if($email_required) { echo '<i class="fas fa-asterisk"></i>'; } ?></label>
						<input type="text" <?php if($email_required) { echo "required"; } ?> name="email" value="<?php esc_html_e($email); ?>" >
				...
				<div class="col-md-6">
					<div class="input-with-icon medium-icons">
						<label><?php esc_html_e('Phone', 'listeo_core'); ?><?php if($phone_required) { echo '<i class="fas fa-asterisk"></i>'; } ?> </label>
						<input type="text" <?php if($phone_required) { echo "required"; } ?> name="phone" value="<?php esc_html_e( get_user_meta( $current_user->ID, 'billing_phone', true) ); ?>" >
