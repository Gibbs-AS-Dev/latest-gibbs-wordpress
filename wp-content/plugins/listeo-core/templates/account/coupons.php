...
<table class="my_account_orders shop_table shop_table_responsive">
	<thead>
	<tr>
		<th><?php echo esc_html_e('Kode','listeo_core'); ?></th>
		<th><?php echo esc_html_e('Type','listeo_core'); ?></th>
		<th><?php echo esc_html_e('Verdi','listeo_core'); ?></th>
	...
	foreach ($ids as $coupon_id) {
		...
		<tr>
			...
			<td data-title="<?php echo esc_html_e('CType','listeo_core'); ?>" ><?php echo esc_html( wc_get_coupon_type( $coupon->get_discount_type() ) ); ?></td>
