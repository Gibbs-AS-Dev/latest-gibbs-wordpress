<div class="<?php echo $row['class'];?>">
	<div class="form-group div_main_tl">
        ...
        <input type="email" class="form-control input_field <?php if($row['required'] == true){?>required<?php } ?>" <?php if(isset($row['org-name'])){?>org-name="<?php echo $row['org-name'];?>" <?php } ?> id="<?php echo $row['name'];?>" name="<?php echo $row['name'];?>" <?php if($row['required'] == true){ ?> required <?php } ?> value="<?php echo $row['value'];?>" <?php if(isset($row['attribute'])){ echo $row['attribute']; } ?> >
    </div>
</div>