<div id="userModal" class="modal user_org_modal">

  <!-- Modal content -->
  <div class="modal-content">
    <div class="modal-header">
      <span class="close close_user">&times;</span>
      <h2><?php  echo __("Create new","Gibbs");?></h2>
    </div>
    <div class="modal-body">
      ...
      <form method="post" class="user_register_form" action="javascript:void(0)">
          <input type="hidden" name="action" value="save_org_user">
          <?php
          global $wp;
          ...
          <div class="row">
            <div class="form-group col-sm-6">
              <label><?php echo __("Organisation name","gibbs");?></label>
              <input class="form-control" name="first_name" type="text" placeholder="<?php echo __("Enter organisation Name","gibbs");?>">
            </div>
            <div class="form-group col-sm-6">
              <label><?php echo __("Org nr.","gibbs");?></label>
              <input class="form-control" name="company_number" type="text" placeholder="<?php echo __("Enter Org nr.","gibbs");?>">
            </div>
            <div class="form-group col-sm-6">
              <label><?php echo __("Email","gibbs");?>Email</label>
              <input class="form-control" name="email" type="email" placeholder="<?php echo __("Enter Email","gibbs");?>" required="">
            </div>
            <div class="form-group col-sm-6">
              <label><?php echo __("Phone","gibbs");?></label>
              <input class="form-control" name="phone" type="text" placeholder="<?php echo __("Enter Phone","gibbs");?>">
            </div>
