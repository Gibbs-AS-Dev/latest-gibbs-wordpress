   ...
   <!--  <footer>
    ...
    border-radius: 10px;">
    	...
    	if(isset($pdftext["title"])){ ?>
	    	<div class="top-text">
	    		<h2><?php echo __($pdftext["title"],"gibbs_core");?></h2>
	    		<?php if(isset($pdftext["description"]) && $pdftext["description"] != ""){ ?>
	    		   <p style="padding-bottom: 10px;"><?php echo __($pdftext["description"],"gibbs_core");?></p>
	    		<?php } ?>   
	    	</div>
	    <?php } ?>
        ...
        if(isset($pdf_data["application"]) && !empty($pdf_data["application"])){ 
        	...
        	foreach ($pdf_data["application"] as $key_app => $application_dd) { 
		            ...
		            <div class="application">	
			            <h2> <?php echo __("Søknad","gibbs_core");?> #<?php echo $key_app;?></h2>	
							    ...
							    <tr>
					                <td class="first_divv">
					            		...
					            		?>
								            		<div class="inner-tb">
									                    <span class="first"><b><?php echo  __($label,'gibbs_core_'.$form_name);?>:</b></span>
									                    <span style="word-wrap: break-word;"><?php echo __($value,"gibbs_core");?></span>
									                </div>
											    ...
											    <?php if($key_app_data == "application_fields"){
									            		...
									            		?>
											            		<div class="inner-tb">
									                                <span class="first"><b><?php echo  __($label,'gibbs_core_'.$form_name);?>:</b></span>
												                    <span><?php echo __($value,"gibbs_core");?></span>
												                </div>
											    	    <?php }
