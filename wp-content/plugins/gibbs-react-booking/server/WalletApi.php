...
class WalletApi {
    ...
    private function addFunds($input) {
        try {
            ...
            if(!class_exists('Class_Gibbs_Subscription')){
                $gibbs_subscription_path = dirname( __FILE__, 5 ) . '/wp-content/plugins/gibbs-subscription/includes/class-gibbs-subscription.php';
    ...
    private function validateJWTToken($token) {
        try {
            ...
            $jwt_file = dirname( __FILE__, 2 ) . '/includes/class-custom-jwt.php';
