    ...
    <a href="<?php the_permalink(); ?>"><h3><?php the_title(); ?></h3></a>
      ...
      if(!empty($share_options)) {
        ...
        <ul class="share-buttons margin-top-40 margin-bottom-0">
          <?php if (in_array("facebook", $share_options)) { ?><li><?php echo '<a target="_blank" class="fb-share" href="https://www.facebook.com/sharer/sharer.php?u=' . $url . '"><i class="fa-brands fa-facebook"></i> Share</a>'; ?></li><?php } ?>
