...
<li class="<?php echo implode(' ',$class); ?>" id="booking-list-<?php echo esc_attr($data->ID);?>">
		...
		<div class="list-box-listing-content">
			<div class="inner">
				...
				<div class="inner-booking-list">
					...
					<ul class="booking-list">
						<li class="highlighted" id="price" dfdfdf>
				...
				<?php		
				$discountType = get_post_meta($data->ID, 'discount-type')[0];		
				if(!empty($discountType)): ?>
				<div class="inner-booking-list">
					<h5><?php esc_html_e('Målgruppe:', 'listeo_core'); ?></h5>
					<ul class="booking-list">
						<li class="highlighted" id="discount-type">
	...
	<div class="buttons-to-right"  >
		<?php if($show_reject) : ?>
            <a href="#" class="button gray newoffer"><i class="fa fa-paper-plane"></i> Gi tilbud</a>
        <?php endif; ?>
