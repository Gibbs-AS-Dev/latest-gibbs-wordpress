...
<div class="row" id="waller-row" data-numberFormat= <?php if(wc_get_price_decimal_separator() == ',') { echo 'euro'; } ?>>
	...
	foreach ($commissions as $commission) { 
		if($commission['status'] == "unpaid") :
			...
			if($bk_idd != ""){
				...
				$dibs_payment_id = get_post_meta($bk_idd,"_dibs_charge_id",true);
				if($dibs_payment_id != ""){
	...
	<div class="col-lg-4 col-md-6">
		<div class="dashboard-stat color-1">
			<div class="dashboard-stat-content wallet-totals"><h4><?php echo wc_price($balance,array('currency'=>' ','decimal_separator' => '.' )); ?></h4> <span><?php esc_html_e('Til utbetaling') ?> <strong class="wallet-currency"><?php echo $currency_symbol; ?></strong></span></div>
...
<div class="row">
	<div class="col-lg-6 col-md-12">
		<div class="dashboard-list-box invoices with-icons margin-top-20">
			<h4><?php esc_html_e('Earnings','listeo_core') ?> <div class="comission-taken"><?php esc_html_e('Fee','listeo_core'); ?>: <strong><?php echo get_option('2.99',2.99) ?>%</strong></div></h4>
			<?php if($commissions) {?>
			<ul>
				<?php 
				foreach ($commissions as $commission) { 
					...
					<li class="commission-<?php echo $commission['status']; ?>"><i class="list-box-icon sl sl-icon-basket"></i>
						...
						<?php if($commission['status'] == 'paid') { ?> <span class="commission-tag-paid">fdfdf<?php esc_html_e('Utbetalt'); ?></span> <?php } ?>
						<ul>
