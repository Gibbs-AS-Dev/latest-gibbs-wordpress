...
<div class="row">
	...
	<div class="col-lg-6 col-md-6" id="dashboard-active-listing-tile" <?php if($user_post_count == 0 || $user_post_count == ""){ echo 'style="display:none"';}?>>
		<div class="dashboard-stat color-1">
			<div class="dashboard-stat-content"><h4><?php  echo $user_post_count; ?></h4> <span><?php esc_html_e('Aktive utleieobjekter','listeo_core'); ?></span></div>
	...
	<!-- Item -->
	<div class="col-lg-6 col-md-6"  id="dashboard-stat-listing-tile" <?php if($total_views == 0 || $total_views == "" || $user_post_count == 0 || $user_post_count == ""){ echo 'style="display:none"';}?>>
