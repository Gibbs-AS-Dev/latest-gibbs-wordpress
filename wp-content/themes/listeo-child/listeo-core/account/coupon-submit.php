	...
	<form action="<?php echo get_permalink($coupons_page); ?>" method="post" id="submit-listing-form" class="listing-manager-form" enctype="multipart/form-data">
		...
		<div class="add-listing-section row">
			<div class="add-listing-headline">
				<h3>  <?php esc_html_e('Rabattkode innstillinger','listeo_core'); ?></h3>
			</div>
			<div class="col-md-12">
				<p class="form-field coupon_amount_field ">
					<label for="coupon_amount"><?php esc_html_e('Rabattkode','listeo_core'); ?></label>
			...
			<!-- <div class="col-md-12">
				<p class="form-field coupon_amount_field ">
					<label for="coupon_amount"><?php esc_html_e('Beskrivelse','listeo_core'); ?></label>
		...
		<!-- 	<div class="col-md-12">
			...
			<div id="general_coupon_data" class="panel woocommerce_options_panel" style="display: block;">
				...
				<div class="col-md-3">
					<p class="form-field coupon_amount_field ">
						<label for="coupon_amount"><?php esc_html_e('Beløp','listeo_core'); ?></label>
		...
		<div id="usage_restriction_coupon_data" class="panel woocommerce_options_panel" style="display: block;">
				...
				<p class="form-field">
					...
					?>
					<label><?php esc_html_e('Utleieobjekt:','listeo_core'); ?><i class="tip" data-tip-content="<?php esc_html_e('La det stå tomt her, om kupongen skal være til alle dine utleieobjekter','listeo_core'); ?>"></i></label>
				...
				<div id="usage_limit_coupon_data" class="panel woocommerce_options_panel" style="display: block;">
					<div class="col-md-12">
						<p class="form-field usage_limit_field ">
							<label for="usage_limit"><?php esc_html_e('Antall ganger en rabattkode kan brukes','listeo_core'); ?></label>
...
<!-- 		<div class="add-listing-section row">
	...
	<p>
		...
		<button type="submit" value="Opprett rabattkode" name="submit_coupon"  class="button margin-top-20"><i class="fa fa-circle-arrow-right"></i> 
			<?php if ( isset( $data->coupon_edit ) && $data->coupon_edit ) { esc_html_e('Update Coupon','listeo_core'); } else { esc_html_e('Opprett rabattkode','listeo_core'); }?>
		</button>
