...
?>
<style>
	.wallet-div .inner-wlt-div{
		display: flex;
		justify-content: space-between;
	}
	.wallet-div .inner-wlt-div .left-inv{
		display: flex;
		gap: 5px
	}
</style>
<div class="row" id="waller-row" data-numberFormat= <?php if(wc_get_price_decimal_separator() == ',') { echo 'euro'; } ?>>
	...
	foreach($data_balance as $data_bal_key => $data_bal){
		//echo "<pre>"; print_r($data_bal);
	?>
		<div class="col-lg-6 col-md-6">
			<div class="dashboard-stat color-1">
				<div class="dashboard-stat-content wallet-totals"><h4><?php echo wc_price($data_bal,array('currency'=>' ','decimal_separator' => '.' )); ?></h4> <span><?php esc_html_e('Til utbetaling') ?> <strong class="wallet-currency"><?php echo $data_bal_key; ?></strong></span></div>
	...
	<?php }
        ...
        <div class="col-lg-6 col-md-6">
			<div class="dashboard-stat color-1">
				<div class="dashboard-stat-content wallet-totals"><h4><?php echo wc_price(0,array('currency'=>' ','decimal_separator' => '.' )); ?></h4> <span><?php esc_html_e('Til utbetaling') ?> <strong class="wallet-currency"><?php echo $user_currency; ?></strong></span></div>
				<div class="dashboard-stat-icon"><svg viewBox="0 0 22.16 22.16" xmlns="http://www.w3.org/2000/svg"><title/><g data-name="Camada 2" id="Camada_2"><g data-name="Camada 1" id="Camada_1-2"><path d="M4.35,7.79A2.2,2.2,0,0,0,5.2,8v.48a.16.16,0,0,0,0,.12.16.16,0,0,0,.12,0h.43a.16.16,0,0,0,.12,0,.16.16,0,0,0,0-.12V8a2.05,2.05,0,0,0,1.16-.45,1.22,1.22,0,0,0,.43-1,1.2,1.2,0,0,0-.17-.67,1.27,1.27,0,0,0-.53-.43,4.79,4.79,0,0,0-1-.31A5.36,5.36,0,0,1,5.19,5a.89.89,0,0,1-.34-.22.46.46,0,0,1-.11-.31A.47.47,0,0,1,5,4a1.06,1.06,0,0,1,.6-.14A1,1,0,0,1,6.12,4a.56.56,0,0,1,.27.37.2.2,0,0,0,.2.12h.65a.14.14,0,0,0,.14-.14,1.1,1.1,0,0,0-.18-.52,1.53,1.53,0,0,0-.49-.47A1.9,1.9,0,0,0,6,3.14V2.65a.15.15,0,0,0-.17-.17H5.36a.16.16,0,0,0-.12,0,.16.16,0,0,0,0,.12v.48a1.8,1.8,0,0,0-1.06.45,1.21,1.21,0,0,0-.39.91,1.12,1.12,0,0,0,.38.91,2.92,2.92,0,0,0,1.19.51q.49.13.74.22a1,1,0,0,1,.38.22.42.42,0,0,1,.12.31.51.51,0,0,1-.24.44,1.31,1.31,0,0,1-.72.16,1.22,1.22,0,0,1-.67-.16.74.74,0,0,1-.32-.39.31.31,0,0,0-.09-.1.22.22,0,0,0-.13,0H3.77a.15.15,0,0,0-.11,0,.14.14,0,0,0,0,.1,1.16,1.16,0,0,0,.2.6A1
		<div class="dashboard-stat-content"><h4><?php echo $data->total_orders; ?></h4> <span><?php esc_html_e('Totale bookinger','listeo_core'); ?></span></div>
...
<div class="row">
	<div class="col-lg-6 col-md-12">
		<div class="dashboard-list-box invoices with-icons margin-top-20 wallet-div">
			<h4 class="inner-wlt-div">
				<span><?php esc_html_e('Earnings','listeo_core') ?></span>
				<div class="left-inv">
					<div class="comission-inv">
						<div class="comission-taken"><?php esc_html_e('Fee','listeo_core'); ?>: <strong><?php 
						$commissionn = get_user_meta($cr_user,"commission",true);
						if($commissionn != ""){
							echo $commissionn;
						}else{
						echo get_option('2.99',2.99);
						} ?>%</strong>
						</div>
					</div>
					<div class="filter-m">
						<?php 
							$months = [
								["month" => "Januar", "value" => 1, "label" => "lab1"],
								["month" => "Februar", "value" => 2, "label" => "lab2"],
								["month" => "Mars", "value" => 3, "label" => "lab3"],
								["month" => "April", "value" => 4, "label" => "lab4"],
								["month" => "Mai", "value" => 5, "label" => "lab5"],
								["month" => "Juni", "value" => 6, "label" => "lab6"],
								["month" => "Juli", "value" => 7, "label" => "lab7"],
								["month" => "August", "value" => 8, "label" => "lab8"],
								["month" => "September", "value" => 9, "label" => "lab9"],
								["month" => "Oktober", "value" => 10, "label" => "lab10"],
								["month" => "November", "value" => 11, "label" => "lab11"],
								["month" => "Desember", "value" => 12, "label" => "lab12"]
							];
							$currentDate = date('Y-m-d');

							// Get the timestamp for the previous month (current month - 1)
							$lastMonthTimestamp = strtotime($currentDate . ' -1 month');

							// Get the name of the previous month
							$lastMonth = date('m', $lastMonthTimestamp);
							$currentMonth = date('m');
						?>
						<div style="position: relative; display: inline-block;">
    <select style="height: 32px;
        padding: 0px 30px 0px 10px; /* Space for chevron */
        margin-top: -3px;
        background: #008474;
        color: #fff;
        font-weight: 600;
		...
		<option value="<?php echo $lastMonth;?>" <?php if(isset($_GET["month"]) && $_GET["month"] == $lastMonth){ ?> selected <?php } ?>>Forrige måned</option>
		<option value="<?php echo $currentMonth;?>" <?php if(isset($_GET["month"]) && $_GET["month"] == $currentMonth){ ?> selected <?php } ?>>Nåværende måned</option>
        <option value="all"  <?php if(isset($_GET["month"]) && $_GET["month"] == "all"){ ?> selected <?php } ?>>Alle</option>
        <!-- <?php foreach($months as $month){ ?>
            <option value="<?php echo $month["value"];?>" <?php if(isset($_GET["month"]) && $_GET["month"] == $month["value"]){ ?> selected <?php } ?>>
    ...
    <span style="position: absolute; 
        ...
        font-size: 12px;">▼</span>
			...
			<ul>
				...
				foreach ($commissions as $commission) { 
					...
					//echo "<pre>";print_r($commission); die;
					?>
					<li class="commission-<?php echo $commission['status']; ?>">
					    <?php if(!empty($gift_data) && isset($gift_data["title"])){ ?>
							<i class="list-box-icon fa fa-gift-card"></i>
							<!-- <i class="list-box-icon sl sl-icon-basket"></i> -->
                            <div class="top-title-div">
								<strong><?php echo $gift_data["title"]; ?></strong>
								<span class="commission-tag-paid"><?php esc_html_e('Gavekort'); ?></span>
							</div>
						<?php }else{ ?>
							<i class="list-box-icon fa fa-calendar-week"></i>
							
							<div class="top-title-div">
							<strong><?php echo get_the_title($commission['listing_id']); ?></strong>
								<span class="commission-tag-paid"><?php esc_html_e('Booking'); ?></span>
							</div>
						<?php } ?>
						
						<?php if($commission['status'] == 'paid') { ?> <span class="commission-tag-paid"><?php esc_html_e('Utbetalt'); ?></span> <?php } ?>
						<?php if($order->get_type() == "shop_order_refund"){ ?> <span class="commission-tag-paid" style="background: #ee3535;color: #fff;"><?php esc_html_e('Refundert'); ?></span> <?php } ?>
						<ul>
							<?php if($order->get_type() == "shop_order_refund"){ ?>
							   <li class="unpaid"><?php echo wc_price($total, array('currency' => $currency)); ?></li>
							<?php }else{ ?>
								<li class="paid"><?php echo wc_price($total, array('currency' => $currency)); ?></li>
							<?php }?>
							<li class="unpaid"><?php esc_html_e('Fee','listeo_core'); ?>: -<?php echo wc_price($commission['amount']); ?></li>
                            <?php if($order->get_type() == "shop_order_refund"){ ?>
								<li class="unpaid"><?php esc_html_e('Totalt','listeo_core'); ?>: <span><?php echo wc_price($earning, array('currency' => $currency)); ?></span></li>
								<li><?php esc_html_e('Order','listeo_core'); ?>: #<?php echo $order->get_parent_id(); ?></li>
                            <?php  }else{ ?>
								<li class="paid"><?php esc_html_e('Your Earning','listeo_core'); ?>: <span><?php echo wc_price($earning, array('currency' => $currency)); ?></span></li>
		...
		<?php } ?>
			...
			<!-- Invoices -->
	<div class="col-lg-6 col-md-12">
		<?php $payment_type =  (isset($current_user->listeo_core_payment_type)) ? $current_user->listeo_core_payment_type : 'banktransfer' ; ?>
					...
					<div class="payment-tab <?php if( $payment_type == 'banktransfer') { ?>payment-tab-active <?php } ?> ">
						...
						<div class="payment-tab-content">
							<div class="row">
								...
								<div class="col-md-12">
								<div class="notice notification payout-method-notification"><strong><?php esc_html_e('Legg til følgende informasjon:'); ?></strong> <br> <?php esc_html_e('Navn/Bedriftsnavn, Org nummer, evt.epost til regnskap, kontonummer til utbetaling.'); ?></div>
									<div class="card-label">
										...
										<input type="hidden" name="bank_detail_user_id" value="<?php echo $current_user->ID;?>">
									</div>
								</div>
			...
			<ul>
				...
				foreach ($payouts as $payout) { 
					...
					<li>
						...
						<button class="btn btn-secondary pdf-download-payout" onclick="window.location.href='/?view_payout=<?php echo $payout['id']; ?>&download_pdf=true';"><i class="fa-solid fa-download"></i> PDF</button>
					</li>
...
<?php
if(isset($_GET["popup-saldo"]) && $_GET["popup-saldo"] == "true"){ ?>
<script>
	jQuery(document).ready(function(){
        jQuery(".payout-method").click()
	})
