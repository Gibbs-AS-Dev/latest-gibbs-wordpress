	...
	<div class="messages-inbox">
		...
		<ul>
			...
			foreach ($ids as $key => $conversation) {
				...
				if($conversation->referral && $conversation->referral != ""){
					$booking_string = explode("_", $conversation->referral);
						...
						if($last_msg) {
							...
							<div class="message-by">
								<div class="message-by-headline">
									...
									<h5><?php echo esc_html($name); ?> <?php if($booking_id != "") : ?> <span class="mes_referral" style="float:none;">Booking ID: <?php echo esc_html($booking_id);  ?></span><?php endif; ?> <?php if($referral) : ?><span class="mes_referral" style="float:none;">Listing: <?php echo esc_html($referral);  ?></span><?php endif; ?>
