...
<div class="listing-item-container listing-geo-data"  <?php echo listeo_get_geo_data($post); ?>>

    <div class="listing-item listing-item-grid  <?php if($is_featured){ ?>featured-listing<?php } ?>">
		...
		$template_loader->get_template_part( 't-img');  ?>
