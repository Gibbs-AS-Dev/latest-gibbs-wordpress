	...
	class ASP_Query {
		...
		public function get_posts() {
			...
			ASP_Search_CPT::order_by($ra['allpageposts'], array(
				/**
				 * The relevance has to be ignored! Otherwise results from the primary and secondary logic
				 * will mix together by relevance. And the relevance value can be higher on an OR logic for the same
				 * phrase as the "AND withe exact keyword matches", but still we want the results from the
				 * more strict logic first.
				 */
