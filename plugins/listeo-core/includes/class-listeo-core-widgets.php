		...
		<?php 
			...
			if(!empty($share)):  
			        ...
			        ?>
			         ...
			         <li><?php echo '<a target="_blank" class="twitter-share" href="https://twitter.com/share?url=' . $url . '&amp;text=' . esc_attr($summary ). '" title="' . __( 'Twitter', 'listeo_core' ) . '"><i class="fa-brands fa-twitter"></i> Tweet</a>'; ?></li>
			        <li><?php echo '<a target="_blank"  class="pinterest-share" href="http://pinterest.com/pin/create/button/?url=' . $url . '&amp;description=' . esc_attr($summary) . '&media=' . esc_attr($imageurl) . '" onclick="window.open(this.href); return false;"><i class="fa-brands fa-pinterest-p"></i> Pin It</a>'; ?></li>
			        </ul>
...
class Listeo_Core_Contact_Vendor_Widget extends Listeo_Core_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass    = 'listeo_core  boxed-widget message-vendor contact_widget';
	...
	public function widget( $args, $instance ) {
		...
		if($listing_type == "service"){
	       $terms = get_the_terms( $post->ID, 'service_category' );
			...
			$terms = get_the_terms( $post->ID, 'rental_category' );
		}else{
		...
		if(!empty($contact_form_cats)){
			foreach ($terms as $key_term => $term) {
				 if(in_array($term->term_id, $contact_form_cats)){
				 	$exist_term = "true";
				 	break;
				 }
			}
		...
		?>
		<style type="text/css">
		[id^="widget_contact_widget_listeo"] .sendreq,
		[id^="widget_contact_widget_listeo"] .xoo-el-login-tgr{
			display: none !important;
		}
		</style>
		<h3><i class="fa fa-envelope"></i> <?php echo $title ?></h3>
		<div class="row with-forms  margin-top-0 contact_form">
			<?php
...
public function widget( $args, $instance ) {
		...
		$btn_text = get_post_meta($post_id, '_booking_button_text',true);
		if(empty($btn_text)) {
           $btn_text = "Book Now";
		}
		$_booking_system___external_booking = get_post_meta($post_id,"_booking_system___external_booking",true);
        ...
        ?>	
        	<style type="text/css">
        		.booking-widget,.contact_widget,.widget_listing_owner  {
        			display: none !important
        		}
        	</style>
        <?php	
		...
		<div class="row with-forms  margin-top-0" sddff id="booking-widget-anchor" >		
			<form  autocomplete="off" id="form-booking" >

				<a href="<?php echo $book_btn; ?>" class="button fullwidth margin-top-5" target="_blank"><span class="book-now-text"><?php echo $btn_text; ?></span></a>
				<span style="text-align: center;width: 100%;display: block;"><?php echo $price_show;?></span>
...
class Listeo_Core_Booking_Widget extends Listeo_Core_Widget {
	...
	public function widget( $args, $instance ) {
        ...
        if(isset($post_meta['_booking_system_equipment'][0]) && ($post_meta['_booking_system_equipment'][0] != 0) && ($post_meta['_booking_system_equipment'][0] != "")){
                ...
                <?php if ($post_meta['_listing_type'][0] != 'event') {
                    ...
                    <?php if ($post_meta['_listing_type'][0] == 'service' &&   is_array($slots)) { ?>
                        ...
                        <div class="col-sm-12 col-lg-12" style="padding: 0; margin: 0;">
                            <table class="tabela" style="width:100%;">
                                        ...
                                        <th colspan="2">
                                            <div class="col-md-12" style="padding: 0px;">
                                                <select id="getMonthWidget" style="background: #F9F9F9;float:right; text-align-last: center;margin: 0;height: 30px;font-size: small;border:0;padding: 1px 15px 1px 0px;appearance: none;">
                                                    ...
                                                    </select><i style="position: absolute; right:  5%; top: 1em; font-size: x-small;pointer-events: none;" class="fa fa-chevron-down" aria-hidden="true"></i>
                                            </div>
                                        </th>
                                        <th colspan="2">
                                            ...
                                            <div class="col-md-12" style="padding: 0px;">
                                                ...
                                                <i style="position: absolute; right: 5%; top: 1em; font-size: x-small ;pointer-events: none;" class="fa fa-chevron-down" aria-hidden="true"></i>
                                            </div>
                                        </th>
                                ...
                                <!-- <span class="timer-loader" style="position: absolute; top: 200px; left: 138px; Z-INDEX: 10;">Loading&#8230;</span> -->
                                <div class="timer-loader-new lds-roller" style="position: absolute; top: 200px; left: 138px; Z-INDEX: 10;">
                                ...
                                <tbody id="time-slot-table" class="<?php if (!is_user_logged_in()) {echo 'xoo-el-login-tgr';} ?>">
                                    ...
                                    ?><tr class="<?php echo $i; ?>">
                                            <?php if ($i < 10) {
                                            ?>
                                                <th class='halfright' <?php if ($i == 0) : ?> style="visibility: hidden;" <?php endif; ?>><span class='halfright1'>0<?php echo $i; ?>:00</span></th>
                                            <?php
                                            } else { ?>
                        ...
                        <div class="row col-lg-12" style="margin: 15px 0px 10px 16px;color: black;font-size:14px;">
                            <div class="row">
                                <div class="col-xs-4 col-md-4" style="padding: 0;"><span style="height: 11px;width: 11px;background-color: #1D9781;border-radius: 50%;display: inline-block;"></span><span> Valgt tid</span></div>
                                <div class="col-xs-4 col-md-4" style="padding: 0;"><span style="height: 11px;width: 11px;background-color: #DA697A;border-radius: 50%;display: inline-block;"></span><span> 
                           ...
                           if(!$autobook == 'on'){
                           ?>
                                <div class="col-xs-4 col-md-4" style="padding: 0;"><span style="height: 11px;width: 11px;background-color: #FF9900;border-radius: 50%;display: inline-block;"></span><span> <?php if($_booking_system_equipment != ""){ echo "Partially booked";}else{ echo  "Reservert";}?></span></div>
                           <?php } ?>
                                <?php  $autobook = get_post_meta(get_the_ID(),'_instant_booking',true); 
                                 if($autobook != 'on'){
                           ?>
                           ...
                           <?php } ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-md-4" style="padding: 0;"><span style="height: 11px;width: 11px;background-color: #C1C1C1;border-radius: 50%;display: inline-block;"></span><span> Ikke tilgjengelig</span></div>
                            </div>
                        </div>
						...
						/*Code by karimmughal1 for $recurrenceRule*/
                            ...
                            for (var s = 0; s < smallest; s++) {
                            	  if(smallest){
                             	    jQuery(`.tabela tr.`+ smallest+` th.halfright span.halfright1`).css('visibility', 'hidden');
                       		  }
                            ...
                            jQuery('.tabela .time-slot').click(function() {
                                ...
                                if (clicks == 3) {
                                   ...
                                   // jQuery('.timenotifi').show();
                                    ...
                                    console.log(fromId);
                                    console.log(toId);
                                    <!-- scroll down to dropdown toHours -->
							 <!-- jQuery('#toHours').focus(); -->
							    if (!mobileCheck()) {
                                    jQuery('html, body').animate({
								        scrollTop: eval(jQuery('#toHours').offset().top - 500)
								    }, 2000);
								}    
                                    <!-- scroll down to dropdown toHours -->
                            ...
                            if (listingCategory != 'utstr') {
                                ...
                                if(count_equipment.length > 0){
                                	count_equipment = count_equipment[0];
                                	if(count_equipment != undefined){
                                        for (var key_eq in count_equipment) {
										    if (count_equipment.hasOwnProperty(key_eq)) {
										         for (var key_eq_values in count_equipment[key_eq]) {
												    if (count_equipment[key_eq].hasOwnProperty(key_eq_values)) {

												    	if(parseInt(count_equipment[key_eq][key_eq_values]["adults"]) >= parseInt(count_equipment[key_eq][key_eq_values]["_max_guests"])){
			                                            	paintOneRow(key_eq, key_eq_values, key_eq_values, color = '#DA697A', true);
			                                            }
                    ...
                    <div class="col-lg-12" <?php if ($max_guests == 1) {
                        ...
                        <div class="panel-dropdown <?php if (!is_user_logged_in()) {echo 'xoo-el-login-tgr';} ?>">
                        	...
                        	?>
                            <a href="#" ><?php if($_booking_system_equipment != ""){ esc_html_e('Antall', 'listeo_core'); }else{ esc_html_e('Guests', 'listeo_core');} ?> <span class="qtyTotal" name="qtyTotal">1</span></a>
	...
	public function otherbookings($args, $instance,$__booking_system_service,$_booking_system_rental){
		...
		if ( $post_meta['_listing_type'][0] == 'rental' || $post_meta['_listing_type'][0] == 'service' ) {
			...
			if( $post_meta['_listing_type'][0] == 'rental' ) {
				$records = $this->bookings->get_bookings( 
					...
					date('Y-m-d H:i:s', strtotime('+3 years')), 
					array( 'listing_id' => $post_info->ID, 'type' => 'reservation', 'status' => 'paid'),
		...
		<div class="row with-forms  margin-top-0" 111 id="booking-widget-anchor" >		
			...
			<?php } ?>
				...
				<?php if (($post_meta['_listing_type'][0] == 'rental' || $post_meta['_listing_type'][0] == 'service') &&  get_post_meta($post_info->ID, '_discount', true) == 'on') { 
		            ...
		            if($discountss && is_array($discountss) && count($discountss) > 0){
		       	?>
		            <div class="col-lg-12 discount-dropdown">
...
function my_dequeue() {
	...
	$_booking_system_equipment = get_post_meta(get_the_ID(),"_booking_system_equipment",true);
	...
	if($listing_type == "service"  && ($_booking_system_weekly_view != "" || $_booking_system_equipment != "")){
		
	    wp_deregister_script( 'listeo_core-bookings',101 );
	    wp_dequeue_script( 'listeo_core-bookings',101 );
	}
}
add_action( 'wp_enqueue_scripts', 'my_dequeue', 10 );
