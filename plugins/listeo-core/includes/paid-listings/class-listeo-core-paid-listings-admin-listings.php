	...
	public function listing_packages_page() {
		...
		if (  'edit' === $action ) {
			...
			<div class="woocommerce wrap">
				<h2><?php _e( 'Listing\'s Packages', 'listeo_core' ); ?> <a href="<?php echo esc_url( add_query_arg( 'action', 'add', admin_url( 'admin.php?page=listeo_core_paid_listings_package_editor' ) ) ); ?>" class="add-new-h2"><?php _e( 'Add User Package', 'listeo_core' ); ?></a></h2>
