...
$season_not_section = seasonnotfound();
?>
<div class="main-form-div fade-sec">
	<?php foreach ($season_not_section as $key_section => $top_section) { ?>	
					...
					<div class="row">
					    ...
					    <?php	
					        foreach ($rows as $key_row => $row) { 
								...
								} else if($row['type'] == "custom_text_info"){ 

								    	include("fields/custom_text_info.php");
