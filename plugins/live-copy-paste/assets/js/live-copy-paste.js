(function (window, document, $, undefined) {
  ...
  var BdThemesLiveCopy = {
    ...
    init: function (e) {
      ...
      BdThemesLiveCopy.loadbdtLiveCopyLocalStorage();
    ...
    loadbdtLiveCopyLocalStorage: function () {
      bdtLiveCopyLocalStorage.init({
    ...
    liveCopy: function (e) {
      ...
      bdtLiveCopyLocalStorage.setItem(
        "magic_copy_data",
    ...
    livePaste: function (selectedContainer) {
      bdtLiveCopyLocalStorage.getItem(
        "magic_copy_data",
        function (magicContent) {
          ...
          if (elementType == "section") {
            importModel.elements = BdThemesLiveCopy.setElementId(
            ...
            $.ajax({
              ...
              beforeSend: function () {
                importedContainer.view.$el.append(
                  '<div id="bdt-live-copy-importing-images-loader">Importing Images..</div>'
                );
              },
